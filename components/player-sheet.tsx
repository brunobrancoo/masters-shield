...
export function PlayerSheet({
  ...
  const hpPercentage = playableCharacter.maxHp
    ? (playableCharacter.hp / playableCharacter.maxHp) * 100
    : 100;
  ...
  return (
    ...
    //                 playableCharacter.maxHp !== playableCharacter.hp && (
    ...
    //           {Object.entries(playableCharacter.attributes).map(
    //             ([key, value]) => (
    ...
    //
    //       {/* Inventory */}
    //       {playableCharacter.inventory &&
    //         playableCharacter.inventory.length > 0 && (
    //           <div>
    ...
    //                         <p className="font-bold font-heading text-sm text-text-primary">
    //                           {item.name}
    //                         </p>
    //                         {item.equipped && (
